...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20250509120017_GuidS'
)
BEGIN
    ALTER TABLE [SurveyResponses] ADD [ResponseGuid] uniqueidentifier NOT NULL DEFAULT '00000000-0000-0000-0000-000000000000';
END;
...
BEGIN
    EXEC(N'UPDATE [Contacts] SET [LastActiveTime] = ''2025-05-09T12:00:17.2699180Z''
    WHERE [Id] = 1;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20250509120017_GuidS', N'9.0.4');
END;
